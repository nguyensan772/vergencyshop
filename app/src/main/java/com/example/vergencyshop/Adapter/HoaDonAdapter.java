...
public class HoaDonAdapter extends RecyclerView.Adapter<HoaDonAdapter.HolderHoaDonAdapter>{
    ...
    public void onBindViewHolder(@NonNull HolderHoaDonAdapter holder, int position) {
        ...
        holder.tvIdHoaDon .setText(list.get(position).getIdHD()); ;
        holder. tvNgayTaoHoaDon .setText(list.get(position).getNgayMua());
        reference.child("NguoiDung").child(list.get(position).getIdND()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    holder.tvKhachHangHoaDon.setText(nguoiDung.getTen());
                    holder. tvSoDienThoaiHoaDon .setText(nguoiDung.getSoDienThoai());
                    holder.tvDiaChiHoaDon .setText(nguoiDung.getDiaChi());
                }
        ...
        holder. tvTongTienHoaDon.setText(list.get(position).getThanhTien());
    }
